...
/*!********************************************!*\
  !*** ./src/js/modules/changeModalState.js ***!
  \********************************************/
/*! exports provided: default, windowWidth, windowHeight, windowProfile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "windowProfile", function() { return windowProfile; });
...
/* harmony import */ var _requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./requiredInputStyle */ "./src/js/modules/requiredInputStyle.js");
...
console.log(_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"][0].nextElementSibling);
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    function showModal(modalSelector, displayStyle) {
      ...
      if (/Android|webOS|iPhone|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {//condition for mobile browser
      } else {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (target.classList.contains('popup_calc_button')) {
          if (_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowWidth"][0].value && _changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowHeight"][0].value) {
            hideModal();
            showModal(modal, 'block');
          }

          if (_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowWidth"][0].value) {
            Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["removeRequiredStyle"])(_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowWidth"][0]);
          } else {
            Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["addRequiredStyle"])(_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowWidth"][0]);
          }

          if (_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowHeight"][0].value) {
            Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["removeRequiredStyle"])(_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowHeight"][0]);
          } else {
            Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["addRequiredStyle"])(_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowHeight"][0]);
          }
        } else if (target.classList.contains('popup_calc_profile_button')) {
          if (_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"][0].checked || _changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"][1].checked) {
            hideModal();
            showModal(modal, 'block');
          }

          if (_changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"][0].checked || _changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"][1].checked) {
            _changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"].forEach(function (item) {
              Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["removeRequiredStyle"])(item.nextElementSibling);
            });
          } else {
            _changeModalState__WEBPACK_IMPORTED_MODULE_1__["windowProfile"].forEach(function (item) {
              Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["addRequiredStyle"])(item.nextElementSibling);
            });
          }
          ...
          if (inputsCalcEnd[0] || inputsCalcEnd[1]) {
            inputsCalcEnd.forEach(function (item) {
              Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["removeRequiredStyle"])(item);
            });
          } else {
            inputsCalcEnd.forEach(function (item) {
              Object(_requiredInputStyle__WEBPACK_IMPORTED_MODULE_2__["addRequiredStyle"])(item);
            });
          }
        } else {
          hideModal();
  ...
  function calcScroll() {
    ...
    var scrolledWidth = div.offsetWidth - div.clientWidth;
    div.remove();
  ...
  bindModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false), bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false);
};
...
/***/ "./src/js/modules/requiredInputStyle.js":
/*!**********************************************!*\
  !*** ./src/js/modules/requiredInputStyle.js ***!
  \**********************************************/
/*! exports provided: addRequiredStyle, removeRequiredStyle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addRequiredStyle", function() { return addRequiredStyle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeRequiredStyle", function() { return removeRequiredStyle; });
...
var timer = function timer(id, deadline) {
  // id - place for render; deadline - timer goes to the end
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    ...
    minutes = Math.floor(t / 1000 / 60 % 60),
        //t/1000/60 - all time in m
    hours = Math.floor(t / (1000 * 60 * 60) % 24),
        //t/(1000*60*60 - all time in h
